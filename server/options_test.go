...
func TestWithBasePath(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedAgentCard: "/agent/api/v2/.well-known/agent-card.json",
		...
		},
		{
			...
			expectedAgentCard: "/agent/api/.well-known/agent-card.json",
...
func TestWithBasePathPriority(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedAgentCard: "/from/option/.well-known/agent-card.json",
