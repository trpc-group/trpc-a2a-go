...
// Package v0 provides a compatibility layer for the legacy A2A v0.2.x wire
// protocol. It contains a FROZEN snapshot of the pre-v1.0 protocol types and
// translation glue so that a v1.0 core can keep interoperating with legacy
// peers.
//
// The types in this file mirror protocol/types.go as of the last v0.2.5
// release (commit 3ae6c6f). They represent the historical wire format and
// MUST NOT evolve with the v1 protocol package: only deletions or bug fixes
// that keep wire behavior identical are acceptable.
package v0
