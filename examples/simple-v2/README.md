...
This is the [`examples/simple`](../simple) server rewritten on the v2
`MessageProcessor` contract. It reverses text, and exists to show the one idea
that changed in v2: **you write the agent once, and the framework serves every
consumption mode from that single code path.**
