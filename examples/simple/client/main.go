...
// Package main is an interactive chat client for the simple A2A example server.
...
// longTaskMarker must match examples/simple/server.
...
func printHelp() {
	...
	fmt.Println("  <text>              sync send (blocking)")
